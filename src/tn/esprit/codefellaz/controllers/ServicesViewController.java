       ...
       // root.resize(825, 589);
        ...
        afficher.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                List<OffreService> services = afficher.afficherOffreService();
                ...
                ServicesViewController.this.parentContainer = new TilePane();
...
//               root.getChildren().add(scroll);
                ...
                for (OffreService service : services) {
                    ...
                    ServicesViewController.this.parentContainer.setHgap(10);
                    ServicesViewController.this.parentContainer.setVgap(10);
                    ...
                    ServicesViewController.this.parentContainer.getChildren().add(tilePane);
                    for (Node node : ServicesViewController.this.parentContainer.getChildren()) {
                        if (node instanceof TilePane) {
                            ...
                            tile.setOnMouseClicked((e) -> {
                                ...
                                for (OffreService s : serviceX) {
                                    ...
                                    ServicesViewController.this.prix.setText(Float.toString(s.getPrix()));
                                    ServicesViewController.this.note.setText(Float.toString(s.getNote()));
                    ...
                    .title("Evaluation")
                    .text("Le service a ete evalue avec sucee!")
                    .showInformation();
                                    ...
                                    supprimer.setOnAction((supprimer) -> {
                                     ...
                                     commander.setOnAction(commander -> {
                                            ...
                                            commande commande = new commande(10, Integer.parseInt(tile.getId()),"test") ;
         ...
         String dateStr = formatter.format(date);
                    ...
                    .text("Ce service a ete commande avec sucee!")
                    .showInformation();
                ...
                ServicesViewController.this.parentContainer.prefHeightProperty().bind(root.heightProperty());
                ServicesViewController.this.parentContainer.prefWidthProperty().bind(root.widthProperty());
